...
| | |
| qlheader-lin | Linux version of a tool that adds the 'magic-field' header to an executable binary without creating a zip package. No SEXEC needed |
| | |
...
| | |
| zip2-lin | Linux version of a tool that adds 'magic-field' header to a executable binary and creates a ZIP package. No SEXEC needed |
| **Sinclair ZX81** | |
